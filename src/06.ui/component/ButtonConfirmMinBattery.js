...
export function ButtonConfirmMinBattery(){
    const elementId = 'btn-minimum-level'; // Id of button 
    const elementUI = new NormalButtonUI(elementId);
    // const elementClass = 'buttonConfirmPhysicalPosition';

    const inputId = 14; // Id use for config 17.js
    const inputElementId = elementId; // Id of button 
    const inputField = 'Minimum-level-input';
    const inputEntity = new Battery();
    const displayId = 'Minimum-level-value';
