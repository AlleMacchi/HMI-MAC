var DataWriteList = [
    {
        id: 1,
        url: "src/00.config/data/webserver/write/PLCvariables/IOWriteSelManAuto.html",
        name: '"HMI_PLC".FromHMI.Command.SelManAuto'
    },
    {
        id: 2,
        url: "src/00.config/data/webserver/write/PLCvariables/IOWriteStart.html",
        name: '"HMI_PLC".FromHMI.Command.Start'
    },
    {
        id: 3,
        url: "src/00.config/data/webserver/write/PLCvariables/IOWriteStop.html",
        name: '"HMI_PLC".FromHMI.Command.Stop'
    }
    ,
    {
        id: 4,
        url: "src/00.config/data/webserver/write/PLCvariables/IOWriteReset.html",
        name: '"HMI_PLC".FromHMI.Command.Reset'
    },
    {
        id: 5,
        url: "src/00.config/data/webserver/write/PLCvariables/IOWriteForward.html",
        name: '"HMI_PLC".FromHMI.Command.UpFwdOn'
    },
    {
        id: 6,
        url: "src/00.config/data/webserver/write/PLCvariables/IOWriteBackward.html",
        name: '"HMI_PLC".FromHMI.Command.DownBwdOff'
    },
    {
        id: 7,
        url: "src/00.config/data/webserver/write/PLCvariables/IOWriteGoTo.html",
        name: '"HMI_PLC".FromHMI.Command.GoToPosition'
    },
    {
        id: 8,
        url: "src/00.config/data/webserver/write/PLCvariables/IOWriteSetStep.html",
        name: '"HMI_PLC".FromHMI.Command.updateStep'
    },
    {
        id: 9,
        url: "src/00.config/data/webserver/write/PLCvariables/IOWriteCarrierEnable.html",
        name: '"HMI_PLC".FromHMI.Selection.Carrier.enable'
    },
    {
        id: 10,
        url: "src/00.config/data/webserver/write/PLCvariables/IOWriteCarrierMmOrLogical.html",
        name: '"HMI_PLC".FromHMI.Selection.Carrier.mm_or_logical'
    },
    {
        id: 11,
        url: "src/00.config/data/webserver/write/PLCvariables/IOWriteLifterEnable.html",
        name: '"HMI_PLC".FromHMI.Selection.Lifter.enable'
    },
    {
        id: 12,
        url: "src/00.config/data/webserver/write/PLCvariables/IOWriteChargeEnable.html",
        name: '"HMI_PLC".FromHMI.Selection.Charging.enable'
    },
    {
        id: 13,
        url: "src/00.config/data/webserver/write/PLCvariables/IOWriteNewStep.html",
        name: '"HMI_PLC".FromHMI.Setting.Machine.newStep'
    },
    {
        id: 14,
        url: "src/00.config/data/webserver/write/PLCvariables/IOWriteMinBatteryLevel.html",
        name: '"HMI_PLC".FromHMI.Setting.Battery.minLevelToStartCharge'
    },
    {
        id: 15,
        url: "src/00.config/data/webserver/write/PLCvariables/IOWriteMaxBatteryLevel.html",
        name: '"HMI_PLC".FromHMI.Setting.Battery.maxLevelToStopCharge'
    },
    {
        id: 16,
        url: "src/00.config/data/webserver/write/PLCvariables/IOWriteCarrierSpeed.html",
        name: '"HMI_PLC".FromHMI.Setting.Carrier.Speed'
    },
    {
        id: 17,
        url: "src/00.config/data/webserver/write/PLCvariables/IOWritePositionToReachMM.html",
        name: '"HMI_PLC".FromHMI.Setting.Carrier.PositionToReach_mm'
    },
    {
        id: 18,
        url: "src/00.config/data/webserver/write/PLCvariables/IOWritePositionToReachLogical.html",
        name: '"HMI_PLC".FromHMI.Setting.Carrier.PositionToReach_logical'
    },
    {
        id: 19,
        url: "src/00.config/data/webserver/write/PLCvariables/IOWriteLifterSpeed.html",
    ...
    {
        id: 21,
        url: "src/00.config/data/webserver/write/PLCvariables/IOWritePositionLogic.html",
        name: '"HMI_PLC".FromHMI.Position.logical'
    },
    {
        id: 22,
        url: "src/00.config/data/webserver/write/PLCvariables/IOWritePositionMM.html",
        name: '"HMI_PLC".FromHMI.Position.mm'
    },
    {
        id: 23,
        url: "src/00.config/data/webserver/write/PLCvariables/IOWritePositionUpdate.html",
